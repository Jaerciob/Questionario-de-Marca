        ...
        <CardContent className="text-center p-8">
          ...
          <div className="mt-8">
            <Button 
              ...
              variant="outline"
              className="w-full sm:w-auto bg-white text-blue-600 border-2 border-white hover:bg-blue-50 hover:text-blue-700 font-bold px-10 py-4 shadow-lg transition-all"
            >

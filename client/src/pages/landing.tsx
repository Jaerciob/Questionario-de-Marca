            ...
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-blue-600 to-purple-700 text-white">
              <CardContent className="p-8">
                ...
                <div className="mt-4">
                  <Button 
                    onClick={() => {
                      trackEvent('click_marketingjur_cta_branding_landing', 'engagement', 'landing_page');
                      window.open('https://www.marketingjur.com.br', '_blank');
                    }}
                    variant="outline"
                    className="w-full bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-bold py-3 transition-all"
                  >
